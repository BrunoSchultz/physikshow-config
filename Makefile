...
generate:
	...
	{ echo "Fehler: Python-Skript fehlgeschlagen."; exit 1; }
...
build: generate
	...
	{ echo "Fehler beim Kompilieren. Überprüfe die .log Datei im build/ Ordner."; exit 1; }
	@cd $(BUILD_ORDNER) && pdflatex -interaction=nonstopmode $(TEX_DATEI) > /dev/null 2>&1 || \
	{ echo "Fehler beim zweiten Kompilierdurchlauf. Überprüfe die .log Datei."; exit 1; }
...
overleaf: generate
	...
	{ echo "Fehler beim Erstellen der ZIP-Datei."; exit 1; }
